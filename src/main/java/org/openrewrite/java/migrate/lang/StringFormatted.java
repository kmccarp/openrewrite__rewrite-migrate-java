...
public class StringFormatted extends Recipe {
    ...
    private static class StringFormattedVisitor extends JavaVisitor<ExecutionContext> {
        ...
        public J visitMethodInvocation(J.MethodInvocation m, ExecutionContext ctx) {
            ...
            boolean wrapperNotNeeded = wrapperNotNeeded(arguments.getFirst());
            ...
            Expression select = wrapperNotNeeded ? arguments.getFirst() :
                new J.Parentheses<>(randomId(), Space.EMPTY, Markers.EMPTY, JRightPadded.build(arguments.getFirst()));
